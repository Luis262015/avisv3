...
export default function IncomeCreate({ openShifts, stores }: { openShifts: CashShift[]; stores: Store[] }) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Ingresos', href: '/admin/incomes' }, { title: 'Registrar', href: '' }]}>
            <FlashMessage />
            <div className="mx-auto max-w-2xl p-6">
                ...
                <form onSubmit={(e) => { e.preventDefault(); post('/admin/incomes'); }} className="space-y-5">
                    ...
                    <div className="flex gap-2">
                        <Button type="submit" disabled={processing}>Registrar Ingreso</Button>
