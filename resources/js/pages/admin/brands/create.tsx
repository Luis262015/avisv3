...
export default function BrandCreate() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Marcas', href: '/admin/brands' }, { title: 'Nueva', href: '' }]}>
            <FlashMessage />
            <div className="mx-auto max-w-lg p-6">
                <h1 className="mb-6 text-2xl font-bold">Nueva Marca</h1>
                <form onSubmit={(e) => { e.preventDefault(); post('/admin/brands'); }} className="space-y-4">
                    <div>
                        <Label>Nombre *</Label>
