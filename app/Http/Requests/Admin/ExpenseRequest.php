...
class ExpenseRequest extends FormRequest
{
    ...
    {
        return [
            // Un gasto en efectivo sale del cajón: sin turno no se refleja en el
            ...
            // Siempre atribuible a una tienda, tenga turno o no: sin esto los pagos
    ...
    {
        return [
            'cash_shift_id.required' => 'Un gasto en efectivo debe registrarse contra un turno de caja abierto.',
            'cash_shift_id.exists'   => 'El turno de caja seleccionado no está abierto.',
            'store_id.required'      => 'Debe indicar la tienda a la que corresponde el gasto.',
        ];
    }
}
